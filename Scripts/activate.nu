...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Nana\PycharmProjects\Web App SEO Scraper'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Nana\PycharmProjects\Web App SEO Scraper\Scripts\deactivate.nu'
